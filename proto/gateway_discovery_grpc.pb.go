...
func (c *registryClient) Heartbeat(ctx context.Context, in *RegistryHeartbeatRequest, opts ...grpc.CallOption) (*RegistryHeartbeatResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegistryHeartbeatResponse)
...
func _Registry_Heartbeat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegistryHeartbeatRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegistryServer).Heartbeat(ctx, req.(*RegistryHeartbeatRequest))
	}
...
var Registry_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "geostreamdb.Registry",
